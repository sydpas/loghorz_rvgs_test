...
def main():
    ...
    fig, axes = plt.subplots(1, columns, figsize=((columns+1) * 2, 14))
    ...
    for i, curve in enumerate(non_depth_curves):
        ...
        if curve != 'GR' and curve != 'PE':
            ...
            df.plot(
                ...
                linewidth=0.5, marker='o', markersize='0.2', alpha=0.8, legend=False)
    ...
    plt.tight_layout()
    plt.savefig('../figures/tops_curves_repeat.png')
    plt.show()
